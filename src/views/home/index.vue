    ...
    <div class="home-header">
      <div class="con">
        ...
        <div class="search icon">
          <UseIcon name="home-search" /> 搜一搜：疾病/症状/医生/健康知识
        </div>
      </div>
    </div>
    <!-- 导航 -->
      ...
      <van-row>
        <van-col span="6">
          <router-link to="/" class="nav min">
            <UseIcon name="home-order" />
            <p class="title">药品订单</p>
          </router-link>
        </van-col>
        <van-col span="6">
          <router-link to="/" class="nav min">
            <UseIcon name="home-docs"></UseIcon>
            <p class="title">健康档案</p>
          </router-link>
        </van-col>
        <van-col span="6">
          <router-link to="/" class="nav min">
            <UseIcon name="home-rp"></UseIcon>
            <p class="title">我的处方</p>
          </router-link>
        </van-col>
        <van-col span="6">
          <router-link to="/" class="nav min">
            <UseIcon name="home-find"></UseIcon>
